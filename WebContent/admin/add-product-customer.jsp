      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">
              <a style="background-color: green"  class="nav-link manager-category" data-set=".main-employee-manager" href="/home/Admin_View_Controller_Customer">
                <div>Giới Thiệu Tour</div>
              </a>
            </li>
<!--             <li class="nav-title"> -->
...
<!--             </li> -->
      ...
      <div class="main-content main-product-manager">
            <h2 class="breadcrumb breadcrumb-item">Thêm Tour Giới Thiệu</h2>
          <div class="row">
          
			
            
            <div class="col-lg-4">
              <h6>Tên Tour</h6><p style="color: red"></p>
              <td><input type="text" class="form-control" name="themten" /><%=error%></td>
            </div>
            
            <div class="col-lg-4">
              <h6>Giá</h6><p style="color: red"></p>
              <input type="text" class="form-control" name="gia" />
            </div>
            
            <div class="col-lg-4">
              <h6>Điểm Đến Chính</h6><p style="color: red"></p>
              <input type="text" class="form-control" name="denchinh" />         
            </div>
            
            <div class="col-lg-4">
              <h6>Điểm Đến Phụ</h6><p style="color: red"></p>
              <input type="text" class="form-control" name="denphu" />
            </div>
            
            <div class="col-lg-4">
              <h6>Điểm Bắt Đầu</h6><p style="color: red"></p>
            ...
            <div class="col-lg-4">
              <h6>Thời Gian Kết Thúc</h6><p style="color: red"></p>
            ...
            <div class="col-lg-4">
              <h6>Tổng Số Ngày</h6><p style="color: red"></p>
            ...
            <div class="col-lg-4">
              <h6>Phương Tiện</h6><p style="color: red"></p>
              <input type="text" class="form-control" name="phuongtien" />
            </div>
            	
			<div class="col-lg-4">
              <h6>Trạng Thái</h6></p>
              <td><input type="text" class="form-control" name="huongdanvien" value="0" readonly/>
              
              </td>
            </div>					
            
<!--             <div class="col-lg-4"> -->
<!--               <h6>Mã Hướng Dẫn Viên</h6><p style="color: red"></p> -->
...
<!--             </div> -->
          ...
          <div class="row btn-add-product">
            <div class="col-lg-12">
             ...
             <input type="hidden" name="command" value="inserts">
              <button class="btn btn-success">Giới Thiệu Tour</button>   
